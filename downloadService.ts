...
export const fetchDownload = async (params: DownloadRequest): Promise<DownloadResult> => {
  try {
    ...
    // FerDev API uses 'success' field, NexRay uses 'status'
    ...
    switch (params.platform) {
      ...
      case Platform.TIKTOK:
        ...
        // Video MP4 (FerDev: video, NexRay: data)
        ...
        // Audio MP3 (FerDev: audio, NexRay: music_info.url)
    ...
    return { status: false, error: "Gagal terhubung ke server Pajar ." };
  }
};
